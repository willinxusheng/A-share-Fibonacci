...
# ── 2026 A股休市日（上交所官方公告，北京时区，含被明示为周末休市的补班日）────────
...
# 若未来某年存在「周末补班开市」日，在此显式放行（2026 为空）。
OPEN_EXCEPTION_2026 = set()
...
def is_trading_day(d: dt.date) -> bool:
    if d.weekday() >= 5:  # 5=Sat, 6=Sun
        return d.isoformat() in OPEN_EXCEPTION_2026
    return d.isoformat() not in CLOSED_2026
